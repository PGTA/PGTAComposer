...
inline const ::std::string& Track_Sample::filepath() const {
  // @@protoc_insertion_point(field_get:PGTA.Track.Sample.filePath)
  return *filepath_;
}
inline void Track_Sample::set_filepath(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:PGTA.Track.Sample.filePath)
}
inline void Track_Sample::set_filepath(const char* value) {
  ...
  filepath_->assign(value);
  // @@protoc_insertion_point(field_set_char:PGTA.Track.Sample.filePath)
}
inline void Track_Sample::set_filepath(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:PGTA.Track.Sample.filePath)
}
inline ::std::string* Track_Sample::mutable_filepath() {
  ...
  // @@protoc_insertion_point(field_mutable:PGTA.Track.Sample.filePath)
  return filepath_;
}
...
inline void Track_Sample::set_allocated_filepath(::std::string* filepath) {
  ...
  // @@protoc_insertion_point(field_set_allocated:PGTA.Track.Sample.filePath)
}
...
inline ::google::protobuf::uint64 Track_Sample::frequency() const {
  // @@protoc_insertion_point(field_get:PGTA.Track.Sample.frequency)
  return frequency_;
}
inline void Track_Sample::set_frequency(::google::protobuf::uint64 value) {
  set_has_frequency();
  frequency_ = value;
  // @@protoc_insertion_point(field_set:PGTA.Track.Sample.frequency)
}
...
inline ::google::protobuf::uint32 Track_Sample::probability() const {
  // @@protoc_insertion_point(field_get:PGTA.Track.Sample.probability)
  return probability_;
}
inline void Track_Sample::set_probability(::google::protobuf::uint32 value) {
  set_has_probability();
  probability_ = value;
  // @@protoc_insertion_point(field_set:PGTA.Track.Sample.probability)
}
...
inline float Track_Sample::volumemultiplier() const {
  // @@protoc_insertion_point(field_get:PGTA.Track.Sample.volumeMultiplier)
...
inline void Track_Sample::set_volumemultiplier(float value) {
  ...
  // @@protoc_insertion_point(field_set:PGTA.Track.Sample.volumeMultiplier)
}
...
inline ::google::protobuf::uint64 Track_Sample::starttime() const {
  // @@protoc_insertion_point(field_get:PGTA.Track.Sample.startTime)
  return starttime_;
}
inline void Track_Sample::set_starttime(::google::protobuf::uint64 value) {
  set_has_starttime();
  starttime_ = value;
  // @@protoc_insertion_point(field_set:PGTA.Track.Sample.startTime)
}
...
inline ::google::protobuf::uint32 Track_Group::sampleindex(int index) const {
  // @@protoc_insertion_point(field_get:PGTA.Track.Group.sampleIndex)
...
inline void Track_Group::set_sampleindex(int index, ::google::protobuf::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:PGTA.Track.Group.sampleIndex)
}
inline void Track_Group::add_sampleindex(::google::protobuf::uint32 value) {
  sampleindex_.Add(value);
  // @@protoc_insertion_point(field_add:PGTA.Track.Group.sampleIndex)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
Track_Group::sampleindex() const {
  // @@protoc_insertion_point(field_list:PGTA.Track.Group.sampleIndex)
  return sampleindex_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
Track_Group::mutable_sampleindex() {
  // @@protoc_insertion_point(field_mutable_list:PGTA.Track.Group.sampleIndex)
  return &sampleindex_;
}
...
inline const ::PGTA::Track_Sample& Track::samples(int index) const {
  // @@protoc_insertion_point(field_get:PGTA.Track.samples)
  return samples_.Get(index);
}
inline ::PGTA::Track_Sample* Track::mutable_samples(int index) {
  // @@protoc_insertion_point(field_mutable:PGTA.Track.samples)
  return samples_.Mutable(index);
}
inline ::PGTA::Track_Sample* Track::add_samples() {
  // @@protoc_insertion_point(field_add:PGTA.Track.samples)
  return samples_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::PGTA::Track_Sample >&
Track::samples() const {
  // @@protoc_insertion_point(field_list:PGTA.Track.samples)
  return samples_;
}
inline ::google::protobuf::RepeatedPtrField< ::PGTA::Track_Sample >*
Track::mutable_samples() {
  // @@protoc_insertion_point(field_mutable_list:PGTA.Track.samples)
  return &samples_;
}
...
inline const ::PGTA::Track_Group& Track::groups(int index) const {
  // @@protoc_insertion_point(field_get:PGTA.Track.groups)
  return groups_.Get(index);
}
inline ::PGTA::Track_Group* Track::mutable_groups(int index) {
  // @@protoc_insertion_point(field_mutable:PGTA.Track.groups)
  return groups_.Mutable(index);
}
inline ::PGTA::Track_Group* Track::add_groups() {
  // @@protoc_insertion_point(field_add:PGTA.Track.groups)
  return groups_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::PGTA::Track_Group >&
Track::groups() const {
  // @@protoc_insertion_point(field_list:PGTA.Track.groups)
  return groups_;
}
inline ::google::protobuf::RepeatedPtrField< ::PGTA::Track_Group >*
Track::mutable_groups() {
  // @@protoc_insertion_point(field_mutable_list:PGTA.Track.groups)
  return &groups_;
}
